...
import com.github.klawru.scheduler.util.OneTimeTaskBuilder;
...
class SchedulerClientTest extends AbstractPostgresTest {
    ...
    void rescheduleWhenError() {
        ...
        wailAllExecutionDone();
        assertThat(scheduler.getAllExecution())
                .hasSize(1)
                .first()
    ...
    void scheduleMultipleTaskTest() {
        ...
        assertThat(scheduler.getAllExecution()).hasSize(5);
        assertThat(scheduler.getScheduledExecutions()).hasSize(5);
        ...
        assertThat(scheduler.getScheduledExecutionsForTask(taskB.getName(), Void.class)).hasSize(3);
    }
    ...
    void getExecutionTest() {
        ...
        assertThat(scheduler.getExecution(taskA.instance("1"))).isPresent();
        assertThat(scheduler.getExecution(taskA.instance("2"))).isEmpty();
        assertThat(scheduler.getExecution(taskB.instance("1"))).isEmpty();
    }
